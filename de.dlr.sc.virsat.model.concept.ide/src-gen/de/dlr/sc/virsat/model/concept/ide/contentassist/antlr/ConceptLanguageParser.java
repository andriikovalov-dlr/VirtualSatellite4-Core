...
public class ConceptLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ConceptLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConceptAccess().getDescriptionAssignment_3_2_1(), "rule__Concept__DescriptionAssignment_3_2_1");
			builder.put(grammarAccess.getConceptAccess().getDMFAssignment_3_3(), "rule__Concept__DMFAssignment_3_3");
